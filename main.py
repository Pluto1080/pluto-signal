...
def analyze():
    ...
    try:
        ...
        2. 기본 동물인 '{animal['name']}' 차트 행성들을 이용해서, 그 동물의 기본성격에 어떠한 성격이 더 있는지 간단하지만(6자이내) 정확한 심볼 추가.
        3. 'personality' 섹션에는 왜 그런 수식어가 붙었는지 차트의 중요한 행성들을 이해하기 쉽게 한,두개 찍어주고, 전체적인 성격을 2문단 정도로 적어줘.
